...
-- version: 20260803135215  name: flota_proximo_servicio_v2

DROP VIEW IF EXISTS v_flota_proximo_servicio;
CREATE VIEW v_flota_proximo_servicio
...
prox AS (
  SELECT o.vehiculo_id, o.flota_id, fc.id AS contrato_id,
...
SELECT
  o.vehiculo_id, o.tenant_id, o.flota_id, f.taller_id, px.contrato_id,
