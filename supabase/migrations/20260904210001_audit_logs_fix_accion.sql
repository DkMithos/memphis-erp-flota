...
-- version: 20260904210001  name: audit_logs_fix_accion

-- Corrección: la versión anterior insertaba `v_accion_placeholder()`, que no
-- existe. La acción es simplemente la operación del trigger.
